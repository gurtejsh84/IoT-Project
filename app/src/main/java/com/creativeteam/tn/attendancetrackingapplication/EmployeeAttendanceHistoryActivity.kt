...
class EmployeeAttendanceHistoryActivity : AppCompatActivity() {

    var cal =Calendar.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_employee_attendance_history)
    ...
    private fun retrieveAttendanceHistory(selectedDate: String) {
        ...
        rv_employee_attendance_history.layoutManager = LinearLayoutManager(this)
        rv_employee_attendance_history.adapter = adp
